...
class TestHealthTracking:
    ...
    def test_add_asthma_attack_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.post("/api/asthma?pet_id=" + str(test_pet["_id"]), json={
            "date": "2024-01-15",
            "time": "14:30",
            "duration": "5 minutes",
            "reason": "Stress",
    ...
    def test_add_asthma_attack_no_access(self, client, mock_db, regular_user_token, admin_pet):
        ...
        response = client.post("/api/asthma?pet_id=" + str(admin_pet["_id"]), json={
            "date": "2024-01-15",
            "time": "14:30"
        }, headers={
            "Authorization": f"Bearer {regular_user_token}"
    ...
    def test_get_asthma_attacks_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.get(f"/api/asthma?pet_id={test_pet['_id']}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_update_asthma_attack_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.put(f"/api/asthma/{attack_id}", json={
            "date": "2024-01-15",
            "time": "15:00",
            "duration": "10 minutes",
    ...
    def test_delete_asthma_attack_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.delete(f"/api/asthma/{attack_id}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_add_defecation_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.post("/api/defecation?pet_id=" + str(test_pet["_id"]), json={
            "date": "2024-01-15",
            "time": "14:30",
            "stool_type": "Normal",
            "color": "Brown",
    ...
    def test_get_defecations_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.get(f"/api/defecation?pet_id={test_pet['_id']}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_update_defecation_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.put(f"/api/defecation/{record_id}", json={
            "date": "2024-01-15",
            "time": "15:00",
            "stool_type": "Loose",
            "color": "Brown",
    ...
    def test_delete_defecation_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.delete(f"/api/defecation/{record_id}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_add_litter_change_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.post("/api/litter?pet_id=" + str(test_pet["_id"]), json={
            "date": "2024-01-15",
            "time": "14:30",
            "comment": "Full change"
        }, headers={
    ...
    def test_get_litter_changes_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.get(f"/api/litter?pet_id={test_pet['_id']}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_update_litter_change_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.put(f"/api/litter/{record_id}", json={
            "date": "2024-01-15",
            "time": "15:00",
            "comment": "Updated"
        }, headers={
    ...
    def test_delete_litter_change_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.delete(f"/api/litter/{record_id}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_add_weight_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.post("/api/weight?pet_id=" + str(test_pet["_id"]), json={
            "date": "2024-01-15",
            "time": "14:30",
            "weight": "4.5",
            "food": "Dry food",
    ...
    def test_get_weights_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.get(f"/api/weight?pet_id={test_pet['_id']}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_update_weight_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.put(f"/api/weight/{record_id}", json={
            "date": "2024-01-15",
            "time": "15:00",
            "weight": "4.6",
            "food": "Wet food",
    ...
    def test_delete_weight_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.delete(f"/api/weight/{record_id}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_add_feeding_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.post("/api/feeding?pet_id=" + str(test_pet["_id"]), json={
            "date": "2024-01-15",
            "time": "14:30",
            "food_weight": "100",
    ...
    def test_get_feedings_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.get(f"/api/feeding?pet_id={test_pet['_id']}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
    ...
    def test_update_feeding_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.put(f"/api/feeding/{record_id}", json={
            "date": "2024-01-15",
            "time": "9:00",
            "food_weight": "120",
            "comment": "Updated"
    ...
    def test_delete_feeding_success(self, client, mock_db, regular_user_token, test_pet):
        ...
        response = client.delete(f"/api/feeding/{record_id}", headers={
            "Authorization": f"Bearer {regular_user_token}"
        })
